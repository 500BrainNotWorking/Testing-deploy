...
class Reply(db.Model):
    ...
    #commentID = db.Column(db.Integer, db.ForeignKey('comment.ID'), nullable=False)   #This will be un-commented, only done to avoid conflicts with merging to main initially.
